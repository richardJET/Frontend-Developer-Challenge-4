...
export default function Accessibility() {
    ...
    return (
        <>
            <button className="btn btn-success position-fixed rounded-circle end-0 m-2 z-3" data-bs-toggle="modal" data-bs-target="#accessibilityModal" style={medium}>
                            ...
                            <div className="container bg-white rounded p-3 mb-5">
                                ...
                                <div className="row">
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${alignLeft ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setAlignLeft(!alignLeft)}><FontAwesomeIcon icon={faAlignLeft} size="2xl" className="mb-2" />Align Left</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${alignCenter ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setAlignCenter(!alignCenter)}><FontAwesomeIcon icon={faAlignCenter} size="2xl" className="mb-2" />Align Center</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${alignRight ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setAlignRight(!alignRight)} ><FontAwesomeIcon icon={faAlignRight} size="2xl" className="mb-2" />Align Right</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${highlightTitles ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setHighlightTitles(!highlightTitles)}><FontAwesomeIcon icon={faT} size="2xl" className="mb-2" />Highlight Titles</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${highlightLinks ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setHighlightLinks(!highlightLinks)}><FontAwesomeIcon icon={faLink} size="2xl" className="mb-2" />Highlight Links</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${textMagnifier ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setTextMagnifier(!textMagnifier)}><FontAwesomeIcon icon={faMagnifyingGlass} size="2xl" className="mb-2" />Text Magnifier</button>
                                    </div>
                                </div>
                            </div>
                            <div className="container bg-white rounded p-3 mb-5">
                                ...
                                <div className="row">
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${darkContrast ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setDarkContrast(!darkContrast)}><FontAwesomeIcon icon={faMoon} size="2xl" className="mb-2" />Dark Contrast</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${lightContrast ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setLightContrast(!lightContrast)}><FontAwesomeIcon icon={faSun} size="2xl" className="mb-2" />Light Contrast</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${highContrast ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setHighContrast(!highContrast)}><FontAwesomeIcon icon={faCircleHalfStroke} size="2xl" className="mb-2" />High Contrast</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${highSaturation ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setHighSaturation(!highSaturation)}><FontAwesomeIcon icon={faDroplet} size="2xl" className="mb-2" />High Saturation</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${lowSaturation ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setLowSaturation(!lowSaturation)}><FontAwesomeIcon icon={faEyeDropper} size="2xl" className="mb-2" />Low Saturation</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${monochrome ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setMonochrome(!monochrome)} ><FontAwesomeIcon icon={faCircleHalfStroke} size="2xl" className="mb-2" />Monochrome</button>
                                    </div>
                                </div>
                            </div>
                            <div className="container bg-white rounded p-3 mb-5">
                                ...
                                <div className="row">
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${muteSounds ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setMuteSounds(!muteSounds)}><FontAwesomeIcon icon={faVolumeXmark} size="2xl" className="mb-2" />Mute Sounds</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${stopAnimations ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setStopAnimations(!stopAnimations)}><FontAwesomeIcon icon={faBolt} size="2xl" className="mb-2" />Stop Animations</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${readMode ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setReadMode(!readMode)}><FontAwesomeIcon icon={faBook} size="2xl" className="mb-2" />Read Mode</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${highlightFocus ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setHighlightFocus(!highlightFocus)}><FontAwesomeIcon icon={faCircleDot} size="2xl" className="mb-2" />Highlight Focus</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${highlightHover ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setHighlightHover(!highlightHover)}><FontAwesomeIcon icon={faArrowPointer} size="2xl" className="mb-2" />Highlight Hover</button>
                                    </div>
                                    <div className="col-6 col-md-4 mb-4">
                                        <button className={`btn ${hideImages ? 'btn-success text-white' : 'btn-info'} d-flex flex-column w-100 p-4 h-100 justify-content-center align-items-center`} onClick={() => setHideImages(!hideImages)}><FontAwesomeIcon icon={faImage} size="2xl" className="mb-2" />Hide Images</button>
                                    </div>
                                </div>
                            </div>
                        </div>
